function readAllDICOM(pathRead,pathSave,nBatch,matlabPATH,nameSaveOption)
% -------------------------------------------------------------------------
% function readAllDICOM(pathRead,pathSave,nBatch,matlabPATH,nameSaveOption)
% -------------------------------------------------------------------------
% DESCRIPTION: 
...
%            --> Ex: 8
% 4. matlabPATH: String specifying the full path to the matlab executable 
%                on the system.
%                --> Ex: '/home/martin/Programs/MATLAB/R2016a/bin/matlab'
% 5. nameSaveOption: (optional). If this argument is not present (default)
...
% POST-PROCESSING OF SAVED FILES (default)
if nargin < 5
