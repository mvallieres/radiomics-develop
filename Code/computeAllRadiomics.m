function computeAllRadiomics(pathRead,pathSave,nameRead,nameROI,nameSet,imParam,roiType)
% -------------------------------------------------------------------------
% AUTHOR(S): 
...
for p = 1:nPatient
    ...
    imParamPatient = imParam.(scanType);
    ...
    [radiomics] = computePatientRadiomics(sData,nameROI{p},nameSet{p},imParamPatient);
