...
readAllOrganizedData_batch(pathDICOM,pathDATA,nBatch_Read,matlabPATH,codePATH) % If data is not organized and only in DICOM format, it is still possible to use the function "readAllDICOM.m'.
fprintf('DONE!\n'), toc
